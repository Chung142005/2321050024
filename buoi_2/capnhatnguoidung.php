...
<body>
    ...
    <form action="index.php?page_layout=capnhatnguoidung&id=<?php echo $id ?>" method="post">
        ...
        <div>
            <p> Mật khẩu: </p>
            <input type="password" name="password" placeholder="Mật khẩu" value="<?php echo $nguoiDung['matKhau']; ?>">
        </div>
        <div>
            <p> Họ tên: </p>
        ...
        <div>
            <p> Vai trò: </p>
            <select name="vai_tro">
                <option value="1" <?php echo ($nguoiDung['vai_tro_id']==1) ?"selected" : "" ?> > User </option>
                <option value="2" <?php echo ($nguoiDung['vai_tro_id']==2) ?"selected" : "" ?> > Diễn viên </option>
                <option value="3" <?php echo ($nguoiDung['vai_tro_id']==3) ?"selected" : "" ?> >Đạo diễn </option>
                <option value="4" <?php echo ($nguoiDung['vai_tro_id']==4) ?"selected" : "" ?> >Biên Kịch </option>
                <option value="5" <?php echo ($nguoiDung['vai_tro_id']==5) ?"selected" : "" ?> >Admin </option>
            </select>
        <div>
    ...
    !empty($_POST['vai_tro'])){
        ...
        $sql = "update nguoi_dung set ten_dang_nhap='$tenDangNhap', matKhau='$password', ho_ten='$hoTen', email='$email', sdt='$sdt', ngay_sinh='$ngaySinh', vai_tro_id='$vaiTro' where id=$id";
